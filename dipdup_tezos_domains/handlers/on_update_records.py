...
from dipdup_tezos_domains.types.name_registry.big_map.store_records_key import StoreRecordsKey
from dipdup_tezos_domains.types.name_registry.big_map.store_records_value import StoreRecordsValue
